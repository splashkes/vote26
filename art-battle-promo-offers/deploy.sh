...
# Art Battle Promo Offers Deployment Script
# Deploys the Promo Offers app to DigitalOcean CDN
...
print_status "Starting Art Battle Promo Offers deployment process..."
...
# Build the app
print_status "Building the Promo Offers application for production..."
...
if curl -s -o /dev/null -w "%{http_code}" $CDN_URL | grep -q "200"; then
    print_success "Deployment verified - Promo Offers app is accessible"
else
    print_error "Deployment verification failed"
fi

# Print summary
print_success "Promo Offers App deployment completed!"
echo ""
print_status "📊 Deployment Summary"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
print_status "🌐 URLs:"
echo "  • Promo Offers CDN: https://$CDN_BUCKET.$CDN_REGION.cdn.digitaloceanspaces.com/$CDN_PATH/"
echo "  • Public Offers URL: https://artb.art/o/{USER_HASH}"
echo "  • Admin URL: https://artb.art/o/admin"
echo ""
...
echo "  • Public app: Users access via unique hash link (no auth)"
echo "  • Admin app: Requires ABHQ admin authentication"
echo "  • Creates/manages promotional offers with RFM targeting"
