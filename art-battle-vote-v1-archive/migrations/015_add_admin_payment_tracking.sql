-- Add admin payment tracking to distinguish between Stripe payments and admin-marked payments

-- 1. First, create payment status codes if they don't exist
INSERT INTO payment_statuses (code, description) VALUES 
  ('admin_paid', 'Marked as paid by admin'),
  ('stripe_paid', 'Paid via Stripe')
ON CONFLICT (code) DO NOTHING;

-- 2. Update admin_update_art_status to create payment records when marking as paid
