                  ...
                  <Box>
                    <Flex justify="center" align="center" mb="3">
                      <Button
                        ...
                        onClick={() => !user ? setShowAuthModal(true) : handleVoteClick(selectedArt)}
                        disabled={votedArtIds.has(selectedArt.id)}
                      >
                        {votedArtIds.has(selectedArt.id) ? (
                          <><HeartFilledIcon /> Voted</>
                        ) : !user ? (
                          <><HeartIcon /> <span style={{textDecoration: 'underline', fontWeight: 'bold'}}>Sign in</span> to vote</>
                        ) : (
