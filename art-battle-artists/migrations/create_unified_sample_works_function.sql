-- Create unified sample works function that combines new and legacy formats
-- Run with: PGPASSWORD='6kEtvU9n0KhTVr5' psql -h db.xsqdkubgyqwpyvfltnrf.supabase.co -p 5432 -d postgres -U postgres -f migrations/create_unified_sample_works_function.sql
