-- Create unified sample works function with correct Cloudflare URL format
-- Run with: PGPASSWORD='6kEtvU9n0KhTVr5' psql -h db.xsqdkubgyqwpyvfltnrf.supabase.co -p 5432 -d postgres -U postgres -f migrations/create_unified_sample_works_correct_urls.sql
...
-- Test the function
SELECT 'Unified sample works function created with correct URLs' AS status;