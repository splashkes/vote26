                                                                   pg_get_functiondef                                                                   
--------------------------------------------------------------------------------------------------------------------------------------------------------
 CREATE OR REPLACE FUNCTION public.get_artist_balance_and_currency(p_entry_id integer)                                                                 +
  RETURNS TABLE(balance numeric, currency text, artist_profile_id uuid)                                                                                +
  LANGUAGE plpgsql                                                                                                                                     +
