                                                                                   pg_get_functiondef                                                                                   
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 CREATE OR REPLACE FUNCTION public.transfer_stripe_account(source_profile_id uuid, target_profile_id uuid, preserve_source_account boolean DEFAULT false, dry_run boolean DEFAULT true)+
  RETURNS jsonb                                                                                                                                                                        +
  LANGUAGE plpgsql                                                                                                                                                                     +
  SECURITY DEFINER                                                                                                                                                                     +
