                                                            pg_get_functiondef                                                             
-------------------------------------------------------------------------------------------------------------------------------------------
 CREATE OR REPLACE FUNCTION public.get_events_with_high_auction_value(min_total_value numeric DEFAULT 500, limit_count integer DEFAULT 10)+
  RETURNS TABLE(event_id uuid, total_value numeric, artwork_count bigint, event_date timestamp with time zone)                            +
  LANGUAGE plpgsql                                                                                                                        +
 AS $function$                                                                                                                            +
 BEGIN                                                                                                                                    +
   RETURN QUERY                                                                                                                           +
