-- Improve remaining SMS message templates for winner notifications

-- 4. Update close_auction_manually function with improved message
...
-- 5. Update admin_update_art_status function with improved message
...
BEGIN
  ...
  -- Update the status
  UPDATE art SET status = p_new_status WHERE art_code = p_art_code;
