-- Improve Manual Payment Request Slack Notification
-- Date: 2025-10-20
-- Fixes: Channel name, event formatting, better layout
...
COMMENT ON FUNCTION notify_manual_payment_request_slack() IS 'Sends Slack notification to #payments-artists when artist submits manual payment request';
