-- Fix is_phone_opted_out to check BOTH optouts table AND people.message_blocked
-- This ensures blocked users never receive messages, even if they're not in optouts table
