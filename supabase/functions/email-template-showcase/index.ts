...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .tab-content { padding: 1rem; min-height: 600px; }
            .tab-content.preview-tab { padding: 0.5rem; min-height: 600px; }
            .email-iframe { height: 600px; }
        }
    </style>
</head>
<body>
    ...
    <div class="template-section">
        ...
        <div class="template-content">
            ...
            <div class="template-tabs">
                <button class="tab-btn active" onclick="showTab(this, 'preview1')" style="background: #e74c3c; color: white; font-weight: bold;">📧 EMAIL PREVIEW</button>
            ...
            <div id="preview1" class="tab-content preview-tab active">
    ...
    <div class="template-section">
        ...
        <div class="template-content">
            ...
            <div class="template-tabs">
                <button class="tab-btn active" onclick="showTab(this, 'preview2')" style="background: #e74c3c; color: white; font-weight: bold;">📧 EMAIL PREVIEW</button>
            ...
            <div id="preview2" class="tab-content preview-tab active">
                <div class="subject-line">
    ...
    <div class="template-section">
        ...
        <div class="template-content">
            ...
            <div class="template-tabs">
                <button class="tab-btn active" onclick="showTab(this, 'preview3')" style="background: #e74c3c; color: white; font-weight: bold;">📧 EMAIL PREVIEW</button>
            ...
            <div id="preview3" class="tab-content preview-tab active">
                <div class="subject-line">
