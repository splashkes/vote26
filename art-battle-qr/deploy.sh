...
# Art Battle QR Deployment Script
# Deploys the Art Battle QR app to DigitalOcean CDN
...
CDN_BUCKET="artb"
CDN_REGION="tor1"
CDN_PATH="qr"  # Deploy to qr subdirectory
...
print_status "Starting Art Battle QR deployment process..."
...
# Build the app
print_status "Building the QR application for production..."
...
if curl -s -o /dev/null -w "%{http_code}" $CDN_URL | grep -q "200"; then
    print_success "Deployment verified - QR app is accessible"
else
    print_error "Deployment verification failed"
fi

# Print summary
print_success "QR App deployment completed!"
echo ""
print_status "📊 Deployment Summary"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
print_status "🌐 URLs:"
echo "  • QR App CDN: https://$CDN_BUCKET.$CDN_REGION.cdn.digitaloceanspaces.com/$CDN_PATH/"
echo "  • QR App URL: https://artb.art/qr/"
echo ""
...
echo "  • The QR app is now live at the URLs above"
echo "  • Access requires a secret token: /YOUR_SECRET_TOKEN"
echo "  • Generate secret tokens from the admin panel in the main vote app"
echo "  • QR codes will redirect to: https://artb.art/qr/CODE"