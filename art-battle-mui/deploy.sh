...
# Art Battle MUI Analytics Deployment Script
# Deploys the Art Battle MUI Analytics app to DigitalOcean CDN
...
CDN_BUCKET="artb"
CDN_REGION="tor1"
CDN_PATH="analytics"  # Deploy to analytics subdirectory
...
print_status "Starting Art Battle MUI Analytics deployment process..."
...
# Build the app
print_status "Building the MUI Analytics application for production..."
...
if curl -s -o /dev/null -w "%{http_code}" $CDN_URL | grep -q "200"; then
    print_success "Deployment verified - MUI Analytics app is accessible"
else
    print_error "Deployment verification failed"
fi

# Print summary
print_success "MUI Analytics App deployment completed!"
echo ""
print_status "📊 Deployment Summary"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
print_status "🌐 URLs:"
echo "  • Analytics CDN: https://$CDN_BUCKET.$CDN_REGION.cdn.digitaloceanspaces.com/$CDN_PATH/"
echo "  • Analytics URL: https://artb.art/analytics/"
echo ""
...
echo "  • The Analytics app is now live at the URLs above"
echo "  • Access via URL: https://artb.art/analytics/EVENT_ID (e.g., /AB3048)"
echo "  • Real-time analytics with MUI Charts and Material Design"
echo "  • Displays guest composition, time series, and engagement metrics"