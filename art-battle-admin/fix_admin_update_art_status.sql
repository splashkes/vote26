CREATE OR REPLACE FUNCTION public.admin_update_art_status(p_art_code text, p_new_status text, p_admin_phone text DEFAULT NULL::text, p_actual_amount_collected numeric DEFAULT NULL::numeric, p_actual_tax_collected numeric DEFAULT NULL::numeric, p_payment_method text DEFAULT NULL::text, p_collection_notes text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
