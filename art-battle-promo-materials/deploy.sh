...
# Art Battle Promo Materials Deployment Script
# Based on the deployment pattern used in other vote26 apps

set -e

echo "🚀 Starting Art Battle Promo Materials deployment..."
...
if [ ! -f "package.json" ]; then
    print_error "package.json not found. Please run this script from the art-battle-promo-materials directory."
    exit 1
fi
...
# Deploy all files to promo subdirectory
print_status "Uploading files to s3://artb/promo/..."
...
print_success "Promo Materials app is now available at: https://artb.tor1.cdn.digitaloceanspaces.com/promo/"

# Optional: Open in browser (uncomment if desired)
# if command -v xdg-open &> /dev/null; then
#     xdg-open "https://artb.tor1.cdn.digitaloceanspaces.com/promo/"
# elif command -v open &> /dev/null; then
#     open "https://artb.tor1.cdn.digitaloceanspaces.com/promo/"
# fi
...
echo "  🔗 URL: https://artb.tor1.cdn.digitaloceanspaces.com/promo/"
echo "  🎨 Anonymous access: https://artb.art/promo/AB3333 (replace AB3333 with event EID)"
