-- Fix the INSERT statement to include all required fields including eid, round, easel
...
BEGIN
  ...
  SELECT a.event_id, a.round, a.easel, a.art_code, e.eid
  INTO v_event_id, v_round, v_easel, v_art_id_string, v_eid
  FROM art a
  ...
  ELSE
    -- Add new vote with all required fields
    INSERT INTO votes (
      id,
      art_uuid,
      art_id,
