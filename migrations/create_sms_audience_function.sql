-- Create function to efficiently calculate SMS audience with proper JOINs
-- This avoids the "414 Request-URI Too Large" error from massive IN clauses

CREATE OR REPLACE FUNCTION get_sms_audience(
...
AS $$
  ...
  ORDER BY fp.id
  LIMIT 100000; -- Allow up to 100k results for high-volume campaigns
$$;

-- Grant execute permissions
GRANT EXECUTE ON FUNCTION get_sms_audience(UUID[], UUID[], INTEGER) TO authenticated;
GRANT EXECUTE ON FUNCTION get_sms_audience(UUID[], UUID[], INTEGER) TO service_role;