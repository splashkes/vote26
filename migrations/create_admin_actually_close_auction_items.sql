-- Create improved auction closing function that determines status based on actual bid data
-- This fixes the race condition where check_and_close_expired_auctions makes wrong status decisions

CREATE OR REPLACE FUNCTION admin_actually_close_auction_items(
  p_art_code text,
