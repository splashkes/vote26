-- Fix Voting System: One Vote Per Round with Upsert Behavior
-- Date: 2025-09-25
-- Issue: Users can vote for multiple artists in same round after removing client auth checks
-- Fix: Change vote detection to check round, not individual artwork, implement vote changing
