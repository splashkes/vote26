-- Update send_payment_setup_invitation function to support admin notes
...
BEGIN
  ...
  INSERT INTO payment_invitations (
    ...
    END,
    CASE
      WHEN invite_type = 'email' THEN (
        -- Prepend admin note if provided
        CASE
