-- Fix get_enhanced_payments_admin_data to include artists with active automated payments regardless of balance
-- This ensures artists with pending/processing/failed automated payments always show in Ready to Pay
