-- Enhanced payments admin function with better grouping and recent payments
-- Addresses: 50 artist limit, missing artists with balances, city grouping, recent payments
...
-- Grant access
GRANT EXECUTE ON FUNCTION public.get_enhanced_payments_admin_data() TO authenticated;

-- Create helper function to group artists by city within each balance category
...
GRANT EXECUTE ON FUNCTION public.group_artists_by_city(jsonb) TO authenticated;