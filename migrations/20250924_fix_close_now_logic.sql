-- Fix Close Now Logic - Should Force Immediate Close Without Extension
-- Date: 2025-09-24
-- Issue: "Close Now" button extends auctions by 5 min if recent bids exist
-- Fix: Force immediate closure regardless of recent bids when admin clicks "Close Now"
