-- Add admin link to artist application notifications
-- The deployed function is missing the admin URL that was supposed to be there
...
BEGIN
    BEGIN
        ...
        -- FIXED: Add admin link to main text format
...
'Added admin link to artist application notifications: <https://artb.art/admin/artist/XXXXX|Artist #XXXXX>';