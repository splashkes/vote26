-- Fix send_auction_closing_notifications to use hardcoded from phone
...
DECLARE
  ...
  v_hardcoded_from_phone TEXT := '+18887111857'; -- Hardcoded from phone
BEGIN
  ...
  LOOP
    ...
    SELECT
      ...
      1,
      NOW(),
      v_hardcoded_from_phone  -- Use hardcoded from phone
    FROM people p
    WHERE EXISTS (
