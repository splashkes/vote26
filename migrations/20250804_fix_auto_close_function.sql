-- Fix auto-close function to use the admin_update_art_status function
-- This ensures consistency with manual closing and avoids format string errors

-- Drop the problematic versions
DROP FUNCTION IF EXISTS check_and_close_expired_auctions();
DROP FUNCTION IF EXISTS check_and_close_expired_auctions() CASCADE;

-- Create a simple auto-close function that uses admin_update_art_status
