-- Fix realtime.send() format in broadcast_cache_invalidation function
-- The function was using wrong format (single JSONB object) instead of correct format (4 parameters)
