-- Fix Close Now Logic - Use Bid-Based Status Assignment
-- Date: 2025-09-25
-- Issue: "Close Now" always sets status to 'closed', should be 'sold' if bids exist
-- Fix: Check for bids and set status appropriately: 'sold' (has bids) or 'closed' (no bids)
