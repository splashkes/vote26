-- Fix bid cache invalidation to update both specific and main event endpoints
-- This will make bids update in real-time in both Admin section AND Vote section
