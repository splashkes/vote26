...
# Art Battle Results Deployment Script
# Deploys the Art Battle Results app to DigitalOcean CDN
...
CDN_BUCKET="artb"
CDN_REGION="tor1"
CDN_PATH="results"  # Deploy to results subdirectory
...
print_status "Starting Art Battle Results deployment process..."
...
echo "  • Custom domain: https://artb.art/results/"
echo ""
...
echo "  • Results are accessible at https://artb.art/results/AB3333 format"
echo "  • Individual artworks at https://artb.art/results/AB3333-1-1 format"
