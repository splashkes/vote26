...
-- Store Cloudflare credentials as secrets
...
-- Create a table to store admin phone numbers for easier management
...
-- Update the get_cloudflare_config function to use admin_users table
CREATE OR REPLACE FUNCTION get_cloudflare_config()
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
