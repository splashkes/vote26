-- Create admin-only function to get full auction details including complete bidder information
-- This bypasses RLS to provide producer+ admins with full access to bidder data
...
-- Grant execution permission to authenticated users (function handles its own permission checking)
GRANT EXECUTE ON FUNCTION get_admin_auction_details TO authenticated;