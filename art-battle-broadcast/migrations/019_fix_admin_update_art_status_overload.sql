-- Fix admin_update_art_status function overload conflict
-- Drop the old version and ensure only the enhanced version exists

-- Drop the old 3-parameter version of the function
DROP FUNCTION IF EXISTS admin_update_art_status(text, text, text);

-- Ensure the enhanced version exists (this should already exist from migration 017)
